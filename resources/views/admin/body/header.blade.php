<div class="nav-header">
    <a href="{{ route('dashboard') }}" class="brand-logo">
        ...
        <img id="logo-img" class="logo-abbr" src="{{ asset('') }}admin-toefl/assets/images/logo/Icon.png"
         style="width: 300px; margin-top:10px; margin-left:15px; z-index: 5; position:absolute; top: 0;">
    </a>
