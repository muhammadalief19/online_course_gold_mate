...
<head>
   <!-- All Meta -->
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<title>Admin GoldMate Online Course</title>
    ...
    <link rel="icon" type="image/png" sizes="2x2" href="{{ asset('') }}admin-toefl/assets/images/logo/Icon.png">
...
<body class="body h-100">
		...
		<div class="login-aside text-center d-flex flex-column flex-row-auto">
			<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
				<div class="text-center mb-lg-4 mb-2 pt-5 logo">
					<img class="w-75" src="{{ asset('') }}admin-toefl/assets/images/logo/GoldMateWhite.png" alt="">
				</div>
    ...
    <script src="{{ asset('admin-toefl/assets/js/custom.min.js') }}"></script>
