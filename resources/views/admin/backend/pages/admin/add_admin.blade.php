...
@section('title','Admin Online-Course | Add Admin')
@section('admin')
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="myForm" action="{{ route('store.admin') }}" method="post" class="row g-3" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="roles" class="mb-3" aria-label="Default select example">
